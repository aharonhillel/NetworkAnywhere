...
function find_relevant(result, first_name, email) {
    ...
    html_response += "<br><br> To add new future availability, please  <a href='https://secure-scrubland-04151.herokuapp.com/'>click here:</a> <br><br> To unsubscribe, please <a href='https://secure-scrubland-04151.herokuapp.com/unsubscribec?email="+email+"'>Click here</a>"
    return {
        subject,
        toEmails,
        html_response,
